...
<head>
	...
	<title>Login Admin - Trivi Car Wash</title>
	...
	<div id="container" data-background="res/img/bg.jpg">
		<div class="box box-sm">
			<div class="logo">
				...
				<h1 style="font-size:32pt;letter-spacing:-3px;"><span style="color:#a5c422"> TRIVI </span> Car Wash</h1>
			...
			<div class="form">
				<form action="proses_login.php" method="post">
					...
					<div class="form-group">
						...
						<input type="password" class="form-input" placeholder="password" name="password">6
