          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Bersihkanlah mobil anda bersama TRIVI Car Wash</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i>082386574973</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 08.00 - 20:00 (Setiap Hari)</span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class=></i><span style="color:#a5c422"> TRIVI </span> Car Wash</h1></a>
               </div>
               ...
               <div class="row">
                         ...
                         <div class="owl-carousel owl-theme">
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Bersihkan noda bandel mobil kalian dengan </h3>
                                             <h1>TRIVI Car Wash</h1>
                              ...
                              <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Kinclongkan kendaraan anda hanya pada</h3>
                                             <h1>TRIVI Car Wash</h1>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Welcome To TRIVI Car Wash </p>
                                   <p>Kami adalah tim yang berdedikasi untuk memberikan layanan cuci mobil 
                                   terbaik dan memberikan pengalaman yang nyaman bagi pelanggan kami. 
                                   Sejak didirikan, kami telah berkomitmen untuk menjaga kebersihan dan penampilan mobil Anda.</p>
                                   <p>Sloga Kami BKW yaitu </p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              ...
                              <div class="contact-info">
                                   <p><i class="fa fa-phone"></i> 082386574973</p>
                                   <p><i class="fa fa-envelope-o"></i> <a href="#">triviwash@gmail.com</a></p>
                              </div>
                         </div>
                    </div>
